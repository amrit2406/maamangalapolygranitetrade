...
import vid1 from "../../assets/ab.mp4"
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          >
            <div className="relative rounded-xl overflow-hidden shadow-xl">
              <video
                ...
                // poster="https://img.freepik.com/free-photo/3d-rendering-luxury-business-meeting-working-room-executive-office_105762-1993.jpg?semt=ais_items_boosted&w=740"
              >
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Since 2023, we've been revolutionizing interior and exterior
              surfaces with our innovative polygranite technology. Our products
              combine durability with aesthetic appeal, offering perfect
              solutions for residential and commercial spaces.
            </p>
            <p className="text-gray-600 mb-8">
              What sets us apart is our commitment to sustainable manufacturing
              processes and customer-centric approach. We don't just sell
              products - we provide complete surface solutions tailored to your
              needs.
            </p>
